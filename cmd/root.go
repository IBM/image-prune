...
var defaultUserAgent = "image-prune/" + ImagePruneVersion
...
// Some small style changes to match image-prune were applied, but try to apply any
...
func createApp() (*cobra.Command, *globalOptions) {
	...
	rootCommand := &cobra.Command{
		Use:               "image-prune",
		Long:              "Prune images from remote container registries prior to a semver or time threshold",
		...
		// (image-prune --tls-verify inspect) (causes a warning) and (image-prune inspect --tls-verify) (no warning).
